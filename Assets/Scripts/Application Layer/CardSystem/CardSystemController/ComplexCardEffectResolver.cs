...
{
    public ICardLogicSystemActionCommandHandler cardSystemActionCommandHandler { get; private set; }
    public IStatusEffectCommandHandler cardStatusEffectCommandHandler { get; private set; }
    public ICardSlotSystemActionCommandHandler slotSystemActionCommandHandler { get; private set; }
    public ICardSystemControlActionCommandHandler cardSystemControlActionCommandHandler { get; private set; }
    public ICardSelectionSystemActionCommandHandler cardSelectionSystemActionCommandHandler { get; private set; }
    public ICardDataControlActionCommandHandler cardDataControlActionCommandHandler { get; private set; }
    public ICardFlowDataActionCommandHandler cardFlowDataActionCommandHandler { get; private set; }

    public ICardLogicSystemActionCommandHandler cardLogicSystem => cardSystemActionCommandHandler;

    public IStatusEffectCommandHandler statusSystem => cardStatusEffectCommandHandler;

    public ICardDataControlActionCommandHandler cardDataSystem => cardDataControlActionCommandHandler;

    public ICardFlowDataActionCommandHandler cardFlowSystem => cardFlowDataActionCommandHandler;

    public ICardSlotSystemActionCommandHandler cardSlotSystem => slotSystemActionCommandHandler;

    public ICardSelectionSystemActionCommandHandler cardSelectionSystem => cardSelectionSystemActionCommandHandler;

    public ICardSystemControlActionCommandHandler cardSystem => cardSystemControlActionCommandHandler;
